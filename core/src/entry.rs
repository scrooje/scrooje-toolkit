...
impl Entry {
    ...
    pub fn from_json(bytes: &[u8]) -> Result<Entry, serde_json::Error> {
        ...
        match entry.t {
            ...
            RULESET => Ok(Self::Ruleset(serde_json::from_value(entry.d)?)),
    ...
    pub fn json(&self) -> Result<String, serde_json::Error> {
        let encoded = match self {
            ...
            Self::Ruleset(entry) => EncodedEntry {
                t: RULESET,
                d: serde_json::to_value(entry)?,
            },
        };
...
/// A transaction import ruleset entity.
#[derive(Clone, Debug, Eq, Hash, PartialEq, serde::Deserialize, serde::Serialize)]
...
/// A single import rule action.
#[derive(Clone, Debug, Eq, Hash, PartialEq, serde::Deserialize, serde::Serialize)]
#[serde(rename_all = "SCREAMING_SNAKE_CASE", tag = "ty")]
pub enum RuleAction {
    Rewrite(RuleActionRewrite),
}

/// A transaction rewrite action.
#[derive(Clone, Debug, Eq, Hash, PartialEq, serde::Deserialize, serde::Serialize)]
pub struct RuleActionRewrite {
